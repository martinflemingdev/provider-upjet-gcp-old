...
type InstanceIAMMemberInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/upbound/provider-gcp/apis/workbench/v1beta1.Instance
	Name *string `json:"name,omitempty" tf:"name,omitempty"`

	// Reference to a Instance in workbench to populate name.
	// +kubebuilder:validation:Optional
	NameRef *v1.Reference `json:"nameRef,omitempty" tf:"-"`

	// Selector for a Instance in workbench to populate name.
	// +kubebuilder:validation:Optional
