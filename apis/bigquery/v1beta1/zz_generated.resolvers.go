...
// ResolveReferences of this AnalyticsHubListingIAMMember.
func (mg *AnalyticsHubListingIAMMember) ResolveReferences(ctx context.Context, c client.Reader) error {
	var m xpresource.Managed
	var l xpresource.ManagedList
	r := reference.NewAPIResolver(c, mg)
